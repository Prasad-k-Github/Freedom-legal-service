...
if(isset($_POST["btnlogin"]))
{
	...
	//Select Db
	mysqli_select_db($con,"lawyerdb");

	//Perform SQL
	$sql = "SELECT * FROM clientdata where NIC='$un' AND confirmpw='$pw'";
            ...
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <a href="Signup.php" class="btn btn-primary mr-3 d-none d-lg-block">Sign Up</a>
                    </div>
                </nav>
            </div>
        </div>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-lg-6 py-5">
                    <div class="rounded p-5 my-5" style="background: rgba(55, 55, 63, .7);">
                        <h1 class="text-center text-white mb-4">Log in</h1>
                        <form action="# " method="post">
                            <div class="form-group">
                                <input name="txtUn" type="text" class="form-control border-0 p-4" placeholder="Enter NIC Number"
                                    required="required" />
                            </div>
                            <div class="form-group">
                                <input name="txtPW" type="password" class="form-control border-0 p-4" placeholder="Enter Password"
                                    required="required" />
                            </div>
                            <div>
                                <button name="btnlogin" class="btn btn-primary btn-block border-0 py-3" type="submit">
                                    Log in</a>    
                                </button>
                            </div><br>
                            <div>
                                <p class="">Do you not have a user account?</p>
